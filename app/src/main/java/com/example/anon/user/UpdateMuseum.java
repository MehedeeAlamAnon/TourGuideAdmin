...
import static com.example.anon.user.MainActivity.DATABASE_PATH_MUSEUM;

/**
 * Created by Anon on 03-Feb-18.
 */

public class UpdateMuseum extends AppCompatActivity {
    ...
    protected void onStart() {
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                PlaceList adapter = new PlaceList(UpdateMuseum.this,placeList);
                ...
                listViewPlaces.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                        ...
                        Intent intent= new Intent(getApplicationContext(), UpdateMuseumActivity.class);
