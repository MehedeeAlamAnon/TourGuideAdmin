...
public class AddFamousAttractionActivity extends AppCompatActivity{
    ...
    public void viewAllData(View view){
        ...
        Intent intent = new Intent(AddFamousAttractionActivity.this,FamousAttractionActivity.class);
