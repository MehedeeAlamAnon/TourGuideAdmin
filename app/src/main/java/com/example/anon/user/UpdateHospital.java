...
import static com.example.anon.user.MainActivity.DATABASE_PATH_HOSPITAL;
    ...
    protected void onStart() {
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                PlaceList adapter = new PlaceList(UpdateHospital.this,placeList);
                ...
                listViewPlaces.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                        ...
                        Intent intent= new Intent(getApplicationContext(), UpdateHospitalActivity.class);
